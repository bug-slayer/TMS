	...
	<form class="layui-form layui-form-pane" method="post" action="teacherpaperlist.do">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				...
				lay-verify="required" placeholder="请输入topicid" autocomplete="off" class="layui-input" readonly>
			</div>
			<div class="layui-form-mid layui-word-aux">（不可编辑）</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				...
				lay-verify="required" placeholder="请输入topic" autocomplete="off" class="layui-input" readonly>
			</div>
			<div class="layui-form-mid layui-word-aux">（不可编辑）</div>
		</div>
			...
			<div class="layui-input-inline">
				...
				lay-verify="required" placeholder="请输入keyw" autocomplete="off" class="layui-input" readonly>
			</div>
			<div class="layui-form-mid layui-word-aux">（不可编辑）</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				...
				lay-verify="required" placeholder="请输入guidancer" autocomplete="off" class="layui-input" readonly>
			</div>
			<div class="layui-form-mid layui-word-aux">（不可编辑）</div>
		</div>
...
<blockquote class="layui-elem-quote"><font color="red">选课学生名单(非主讲教师无法编辑学生名单)</font></blockquote>
