...
layui.use(['table','element'], function(){
  ...
  table.render({
    elem: '#test'
    ,url:'getshoukes.do'//在Logincontroller中从而获取用户名，根据其查询授课列表
    ,type:'GET'
    ,page: true
    ...
    ,cols: [[
      ...
      ,{field:'coursename', title:'课程名', width:150, edit: 'text',sort: true}
      ,{field:'courseterm', title:'学期', width:120, edit: 'text', sort: true}
...
<div class="site-text" style="position:relative;left:20%;margin: 5%; display: none" id="student"  target="test123">	
	<form class="layui-form layui-form-pane" method="post" action="teacherjumpstudent.do">
...
<div class="site-text" style="position:relative;left:20%;margin: 5%; display: none" id="topic"  target="test123">	
	<form class="layui-form layui-form-pane" method="post" action="teacherjumptopic.do">
		<div class="layui-form-item">
			<label class="layui-form-label layui-bg-red">课程ID</label>
			<div class="layui-input-inline">
...
<div class="site-text" style="position:relative;left:20%;margin: 5%; display: none" id="teacher"  target="test123">	
	<form class="layui-form layui-form-pane" method="post" action="teacherjumpteacher.do">
		<div class="layui-form-item">
			<label class="layui-form-label layui-bg-red">课程ID</label>
			<div class="layui-input-inline">
...
<blockquote class="layui-elem-quote"><font color="red">教师授课列表</font></blockquote>
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="student">学生管理</a>
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="class">选题管理</a>
  <a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="teacher">教师管理</a>
</script></div>
  </div>
