...
layui.use(['table','element'], function(){
  ...
  table.render({
    elem: '#test'
    ,url:'studentshowstutopicpaperlist.do'//在Logincontroller中从而获取用户名，根据其查询授课列表
    ,type:'GET'
    ,page: true
    ...
    ,cols: [[
      ...
      ,{field:'docl', title:'文件物理位置', width:150, sort: true}
...
<div class="site-text" style="position:relative;left:20%;margin: 5%; display: none" id="comment"  target="test123">	
	<form class="layui-form layui-form-pane" method="post" action="studentjumpcomment.do">
