...
<blockquote class="layui-elem-quote"><font color="red">课程主题列表（该课程已选主题不可再选，可查看选题学生名单及其上传论文列表）</font></blockquote>
...
<script type="text/html" id="barDemo">
  		<a class="layui-btn layui-btn-xs" lay-event="stutopic">选题学生名单</a>
</script>
</div>
</div>
