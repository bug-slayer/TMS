...
layui.use(['table','element'], function(){
  ...
  table.render({
    elem: '#test'
    ,url:'getsclist.do'//在Logincontroller中从而获取用户名，根据其查询授课列表
    ,type:'GET'
    ,page: true
    ...
    ,cols: [[
      ...
      ,{field:'name', title:'主讲教师姓名', width:150, sort: true}
...
<div class="site-text" style="position:relative;left:20%;margin: 5%; display: none" id="topic"  target="test123">	
	<form class="layui-form layui-form-pane" method="post" action="studentshowtopiclist.do">
		...
		<div class="layui-form-item">
			<label class="layui-form-label layui-bg-red">主讲教师姓名</label>
			<div class="layui-input-inline">
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn layui-btn-radius" lay-submit lay-filter="formDemo">查看主题列表</button>
...
<blockquote class="layui-elem-quote"><font color="red">学生选课列表</font></blockquote>
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="topic">查看主题</a>
